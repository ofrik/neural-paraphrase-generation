...
tf.flags.DEFINE_integer('batch_size', 64, 'random seed for training sampling')
...
tf.flags.DEFINE_integer('input_max_length', 60, 'Max length of input sequence to use')
tf.flags.DEFINE_integer('output_max_length', 60, 'Max length of output sequence to use')

tf.flags.DEFINE_bool('use_residual_lstm', True, 'To use the residual connection with the residual LSTM')

# Data related
tf.flags.DEFINE_string('input_filename',
                       'data/ppdb/train_source.txt,data/mscoco/train_source.txt,data/wikianswers/train_source.txt,data/wikianswers/train_source_1.txt',
                       'Name of the train source file')
tf.flags.DEFINE_string('output_filename',
                       'data/ppdb/train_target.txt,data/mscoco/train_target.txt,data/wikianswers/train_target.txt,data/wikianswers/train_target_1.txt',
